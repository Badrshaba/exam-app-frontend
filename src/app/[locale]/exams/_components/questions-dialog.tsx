...
export default async function QuestionsDialog({ searchParams }: QuestionsDialogProps) {
  ...
  return (
    <Dialog>
      {/* Trigger */}
      <DialogTrigger className="bg-blue-600 text-white px-4 py-2 rounded-md">Start</DialogTrigger>
